...
/* harmony import */ var _components_Transition_Spinner_ScaleLoader__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../components/Transition/Spinner/ScaleLoader */ "./components/Transition/Spinner/ScaleLoader.js");
...
var JobsContainer = function JobsContainer() {
  ...
  var linkIsValid = function linkIsValid() {
    ...
    if (validator__WEBPACK_IMPORTED_MODULE_7___default.a.isEmpty(link.value) && link.value.length === 0) {
      link.isValid = false;
      link.message = "";
      link.isGood = false;
  ...
  if (loading) {
    submitLink = __jsx(_components_Transition_Spinner_ScaleLoader__WEBPACK_IMPORTED_MODULE_11__["default"], {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 114,
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, submitLink, __jsx(_components_Jobs_Job__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
//# sourceMappingURL=jobs.js.8b5ff9bea895d19616f6.hot-update.js.map