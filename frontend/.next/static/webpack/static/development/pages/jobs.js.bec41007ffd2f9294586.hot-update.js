...
var getJob = function getJob(jobId, ctx) {
  return function (dispatch) {
    ...
    _axios_instance__WEBPACK_IMPORTED_MODULE_3__["default"].get("/job/".concat(jobId), headerCfg).then(function (res) {
      if (res.data.concepts === null || res.data.keywords === null) {
        _axios_instance__WEBPACK_IMPORTED_MODULE_3__["default"].get("/concept-keyword-job/".concat(jobId), headerCfg);
        dispatch(getJobSuccess(res.data));
      }

      if (res.data.contents === undefined) {
        _axios_instance__WEBPACK_IMPORTED_MODULE_3__["default"].get("/job/".concat(jobId), headerCfg);
        dispatch(getJobSuccess(res.data));
      }
...
//# sourceMappingURL=jobs.js.bec41007ffd2f9294586.hot-update.js.map