...
var getUser = function getUser(ctx) {
  return function (dispatch) {
    ...
    _axios_instance__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user", headerCfg).then(function (res) {
      console.log("response GET_USER ===> ", res.data);
      dispatch(getUserSuccess(res.data));
    })["catch"](function (err) {
      console.log("error GET_USER ===> ", err.response.status);

      if (err.response.status === 422) {//cookie.destroy(ctx, "access_token");
...
//# sourceMappingURL=_app.js.afd7e4540289a9beb428.hot-update.js.map